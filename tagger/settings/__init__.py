...
from tagger.settings.preferences import (
    ...
    SIMULATOR_ARB_ENABLED_SETTING as SIMULATOR_ARB_ENABLED_SETTING,
    SIMULATOR_ARB_MAX_SIZE_SETTING as SIMULATOR_ARB_MAX_SIZE_SETTING,
    SIMULATOR_ARB_MIN_SIZE_SETTING as SIMULATOR_ARB_MIN_SIZE_SETTING,
    SIMULATOR_ARB_STEP_SETTING as SIMULATOR_ARB_STEP_SETTING,
    SIMULATOR_GRID_TYPE_SETTING as SIMULATOR_GRID_TYPE_SETTING,
    SIMULATOR_NO_UPSCALE_SETTING as SIMULATOR_NO_UPSCALE_SETTING,
    SIMULATOR_TRAINING_RESOLUTION_SETTING as SIMULATOR_TRAINING_RESOLUTION_SETTING,
    ...
    get_grid_type as get_grid_type,
    get_preprocess_options as get_preprocess_options,
